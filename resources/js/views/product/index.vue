              ...
              <div class="sidebar-holder">
                    ...
                    <form>
                      <template v-for="category in filterList.categories">
                        <div class="form-group">
                          <input type="checkbox" :value="category.id" v-model="categories" :id="category.id">
                ...
                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                  ...
                  <ul class="color-option">
                    <li v-for="color in filterList.colors">
                      <a @click.prevent="addColor(color.id)" href="#0" class="color-option-single shadow"
                ...
                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                  ...
                  <div class="slider-box">
                    ...
                    <button @click.prevent="filterProducts" class="filterbtn" type="submit">Фильтр</button>
                  </div>
                </div>
              ...
              <div class="col-xl-12">
                <div
                  ...
                  <div class="left-box wow fadeInUp animated">
                    <p>
                      Показано
                      <template v-if="perPage > pagination.total">{{ pagination.total }}</template>
                  ...
                  <div
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" style="">
                        <li><a @click.prevent="getProducts(sortItem = 'created_at', itemSort = 'DESC')"
                               class="dropdown-item" href="#">По
                          новизне</a></li>
                        <li><a @click.prevent="getProducts(sortItem = 'price', itemSort = 'DESC')" class="dropdown-item"
                               href="#">По
                          цене, по убыванию</a></li>
                        <li><a @click.prevent="getProducts(sortItem = 'price', itemSort = 'ASC')" class="dropdown-item"
                               href="#">По
                          цене, по возрастанию</a></li>
                        <li><a @click.prevent="getProducts(sortItem = 'count', itemSort = 'DESC')" class="dropdown-item"
                               href="#">По
                          количеству, по убыванию</a></li>
                        <li><a @click.prevent="getProducts(sortItem = 'count', itemSort = 'ASC')" class="dropdown-item"
                               href="#">По
                          ...
                          <div class="products-three-single-img"><a
                            ...
                            <div class="products-grid__usefull-links">
                              <ul>
                                ...
                                <li><a :href="`#popup${product.id}`" @click="getProduct(product.id)" class="popup_link">
                                  ...
                                  <div class="quick-view__left-content">
                                    <div class="tabs">
                                      ...
                                      <div class="popup-product-main-image-box">
                                        <div v-for="(productImage, index) in popupProduct.product_images"
                                             :id="`tabb${index}`"
                                  ...
                                  <div class="popup-right-content">
                                    ...
                                    <div class="color-varient">
                                      <tamplate v-for="groupProduct in popupProduct.group_products">
                                        <tamplate @click.prevent="getProduct(groupProduct.id)"
                                                  v-for="color in groupProduct.colors">
                                          <a v-if="groupProduct.id === popupProduct.id" href="#0"
                                             class="color-box shadow"
                                             :style="{ backgroundColor: color.hex_code }"><span>{{ color.title }}</span>
                                          </a>
                                        </tamplate>
                                      </tamplate>
                                    </div>
...
export default {
  ...
  methods: {
    ...
    getSortItem() {
      this.axios.get('http://shop1/api/products')
          .then(res => {
    ...
    getProducts() {
      this.axios.post('http://shop1/api/products', {
    ...
    getProduct(id) {
      this.axios.get(`http://shop1/api/products/${id}`)
          .then(res => {
    ...
    getFilterList() {
      this.axios.get(`http://shop1/api/products/filters`)
          .then(res => {

    ...
    <div>
        ...
        <header class="header-style-3">
            ...
            <div class="menubox">
                <div class="container-fluid">
                    <div class="row d-lg-none d-block">
                      ...
                      <i class="flaticon-magnifying-glass"></i></span></div>
                                    </form>
                                </div>
                                <nav>
                                    <ul
            ...
            <div class="side-cart d-flex flex-column justify-content-between">
                    ...
                    <div class="cart_items">
                        <div class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                                ...
                                <img
                                    src="{{asset('assets/images/shop/products-img1.jpg')}}" alt=""> </a>
                        ...
                        <div class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                                                                           class="thumb d-flex justify-content-between align-items-center">
                                <img
                                    src="{{asset('assets/images/shop/products-img2.jpg')}}" alt=""> </a>
                                <div class="text"><a href="shop-details-1.html">
                        ...
                        <div class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                                                                           class="thumb d-flex justify-content-between align-items-center">
                                <img
                                    src="{{asset('assets/images/shop/products-img3.jpg')}}" alt=""> </a>
                                <div class="text"><a href="shop-details-1.html">
                                    <h6>Diamond Ring </h6>
                                </a>
                        ...
                        <div class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center"><a href="shop-details-2.html"
                                                                           class="thumb d-flex justify-content-between align-items-center">
                                <img
                                    src="{{asset('assets/images/shop/products-img4.jpg')}}" alt=""> </a>
                                <div class="text"><a href="shop-details-1.html">
                                    <h6>Women Earring</h6>
                                </a>
                                    <p>1 X <span>$150.00</span></p>
                ...
                <div class="bottom">
                    ...
                    <div class="button-box d-flex justify-content-between"><a href="cart.html" class="btn_black"> View
                        Cart
                    ...
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo"><a href="index.html"><img src="{{asset('assets/images/logo/logo-2.png')}}" alt=""></a>
                                </div>
        ...
        <footer class="footer-default footer-3 ">
            <div class="footer-default__shap_1 position-absolute "><img
                src="{{asset('assets/images/shape/footer-shape-1.png')}}" alt=""></div>
            <!--Start Footer-->
                ...
                <div class="container">
                    <div class="footer_bottom_content">
                        ...
                        <div class="footer-payment wow fadeInUp animated">
                            <a href="#0"> <img src="{{asset('assets/images/home-four/method-1.jpg')}}" alt="payment">
                            </a>
                            <a href="#0"> <img src="{{asset('assets/images/home-four/method-2.jpg')}}" alt="payment">
                            </a>
                            <a href="#0"> <img src="{{asset('assets/images/home-four/method-3.jpg')}}" alt="payment">
                            </a>
                            <a href="#0"> <img src="{{asset('assets/images/home-four/method-4.jpg')}}" alt="payment">
                            </a>
                        </div>
                    </div>
                </div>

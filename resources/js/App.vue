<template>
    <div>
        <header class="header-style-3">
                        ...
                        <div class="row g-0 position-relative">
                            ...
                            <div class="col-lg-9 g-0 p-0">
                                ...
                                <div class="row g-0 holder">
                                    <div class="col-12">
                                        <div
                                            class="mega-menu-default mega-menu d-lg-block d-none"
                                        >
                                            <div
                            ...
                            <a href="shop-grid.html" class="offer-link">
                                Offer
                            </a>
                        </div>
                    </div>
            ...
            ></div>
            <!--            <div v-on:mouseover="isActive = !isActive" v-bind:class="{ active: isActive }"-->
            ...
            >
                <div class="top">
                    ...
                    >
                        <h6 class="text-uppercase">Your Cart (03)</h6>
                        <span
                            @click="disActiveCart"
                    ...
                    <div class="cart_items">
                        <div
                            v-for="(cart, idx) in productsCart"
                            :key="idx"
                            class="items d-flex justify-content-between align-items-center"
                        >
                            <template v-for="product in products">
                                <template v-if="cart.id === product.id">
                                    <div
                                        class="left d-flex align-items-center"
                                        :key="product.id"
                                    >
                                        <a
                ...
                <div class="bottom">
                    ...
                    >
                        ...
                        <h6 class="ammount text-uppercase">
                            {{ productsCart ? totalPrice : "0" }} .руб
                        </h6>
                    </div>
                    <div class="button-box d-flex justify-content-between">
                        <a href="/cart" class="btn_black"> Смотреть корзину </a>
                        <a
                            ...
                            <div class="content-inner">
                                ...
                                <div class="form_inner">
                                    ...
                                    <form action="index.html" method="post">
                                        ...
                                        <div
                                            class="form-group message-btn mt-4"
                                        >
                                            <button
                                                type="submit"
                                                class="btn--secondary"
                        ...
                        >
                            <div class="footer-default__single-box">
                                ...
                                <div class="footer-newsletter">
                                    <p class="text">
                                        Enter your email to receive our latest
                                        updates about our products & promotions.
                                    </p>
                                    <form
                                        action="#0"
                                    ...
                                    <div
                                        class="newsletter-bottom d-flex align-items-center"
                                    >
                ...
                <div class="container">
                    <div class="footer_bottom_content">
                        <div class="copyright wow fadeInUp animated">
                            <p>
                                © 2022 <a href="index.html">Karte.</a> All
                                Rights Reserved.
                            </p>
                        </div>
    ...
    methods: {
        ...
        getSetInterval() {
            JSON.parse(localStorage.getItem("cart").length) > 2
                ? (this.interval = setInterval(this.getCartProducts, 500))
                : !this.productsCart.length ? this.closeSetInterval
                : this.closeSetInterval;
        },

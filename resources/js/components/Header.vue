        ...
        <div class="side-cart d-flex flex-column justify-content-between">
            <div class="top">
                ...
                <div class="cart_items">
                    <div v-for="cart in productsCart"
                            ...
                            <template v-if="cart.id === product.id">
                                <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                                    ...
                                    <div class="text"><a href="shop-details-1.html">
                                        ...
                                        <p>{{ cart.qty }} X <span>{{ cart.price * cart.qty }} руб</span></p>
                                    </div>
                                </div>
                                <div class="right">
                                    <div class="item-remove"><i @click.prevent="removeProduct(cart.id)"
            ...
            <div class="bottom">
                ...
                <div class="button-box d-flex justify-content-between"><a href="/cart" class="btn_black"> View
                    Cart
                </a> <a @click.prevent="clearCart" href="/cart" class="button-2 btn_theme"> Очистить корзину </a></div>
            </div>
        </div>
                ...
                <div class="sidebar-textwidget">
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo"><a href="/"><img src="{{asset('assets/images/logo/logo-2.png')}}"
                                                               alt=""></a>
                            </div>

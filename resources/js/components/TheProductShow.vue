            ...
            <div class="shop-details-top-right">
              <div class="shop-details-top-right-content-box">
                  ...
                  <ul class="varients">
                    ...
                    <li>
                      <a
                        href="#0"
                        class="shop-details-top-color-sky-img"
                        data-src="/assets/images/shop/products-img2.jpg"
                      >
                        <img
                    ...
                    <li>
                      <a
                        href="#0"
                        class="shop-details-top-color-sky-img"
                        data-src="/assets/images/shop/products-img3.jpg"
                      >
                        <img
                    ...
                    <li>
                      <a
                        href="#0"
                        class="shop-details-top-color-sky-img"
                        data-src="/assets/images/shop/products-img4.jpg"
                      >
                        <img
                ...
                <ul class="shop-details-top-category-tags">
                  ...
                  <li>
                    Tags:
                    <span>platinum watch, gold ring, women jewellary</span>
                  </li>
                </ul>
          ...
          <div class="tab-content" id="pills-tabContent-two">
            ...
            >
              <div class="product-drescription">
                ...
                <p>
                  ...
                  through user friendly colighue to action items. Interactively
                  antidos cultivate interdependent customer service without
                  clicks-and-mortar e-services. Proactively cultivate go forward
                  testing procedures with accurate quality vectors. Globally
                  aiembrace ethical functionalities via empowered scenarios.
                  Phosfluorescently restore highly efficient opportunities and
                  client-focused infomediaries. Enthusiastically transition
                  multidisciplinary outside the box thinking without premium
                  networks. Progressive supply clicks-and-mortar human capital
                  through enterprise-wide web services. Objectivey bester
                  provide access to extensible processes better than more
            ...
            >
              <div class="product-drescription">
                ...
                <ul class="drescription-list">
                  <li>
                    1. Adipiscing hac cubilia, fermentum ipsum auctor parturient
                    tempus lobortis fermentum.
                  </li>
                  <li>
                    2. Euismod disagree soler imperdiet vehicula pede eros ipsum
                    cras mi feugiat.
                  </li>
                  <li>
          ...
          <div class="catagory-slider">
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                >
                  <img src="/assets/images/shop/products-img1.jpg" alt="Alt" />
                </a>
                    ...
                    <div class="col-lg-6">
                      <div class="popup-right-content">
                        ...
                        <div class="ratting">
                          ...
                          <i class="flaticon-star"></i>
                          <i class="flaticon-star"></i>
                          <i class="flaticon-star"></i> <span>(100)</span>
                        </div>
                        <p class="text">
            ...
            <div class="products-grid-one">
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  ...
                  <img src="/assets/images/shop/products-img3.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> blue </span>
                  <img src="/assets/images/shop/products-img4.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Black </span>
                  <img src="/assets/images/shop/products-img5.jpg" alt="Alt" />
                </p>
              </div>
            </div>
            <div class="products-grid-one">
            ...
            <div class="products-grid-one">
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  <span class="color"> blue </span>
                  <img src="/assets/images/shop/products-img6.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Yellow </span>
                  <img src="/assets/images/shop/products-img5.jpg" alt="Alt" />
            ...
            <div class="products-grid-one">
              ...
              <div class="products-grid-one__thumb-box">
                ...
                <p class="products-grid-one__product-varient">
                  <span class="color"> Yellow </span>
                  <img src="/assets/images/shop/products-img7.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> green </span>
                  <img src="/assets/images/shop/products-img8.jpg" alt="Alt" />
                </p>
              </div>
            </div>
            <div class="products-grid-one">
              <div class="products-grid-one__product-image">
                ...
                >
                  <img
                    class="products-grid-one__mainimage products-grid-one__first-img"
                    src="/assets/images/shop/products-img12.jpg"
                    alt="Alt"
                  />
                  <img
                    class="products-grid-one__hover-img"
              ...
              <div class="products-grid-one__thumb-box">
                <p class="products-grid-one__product-varient">
                  <span class="color"> Blue </span>
                  <img src="/assets/images/shop/products-img12.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Green </span>
                  <img src="/assets/images/shop/products-img11.jpg" alt="Alt" />
                </p>
                <p class="products-grid-one__product-varient">
                  <span class="color"> Black </span>
                  <img src="/assets/images/shop/products-img10.jpg" alt="Alt" />
                </p>
              </div>
            </div>
          </div>
